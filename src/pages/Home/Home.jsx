        ...
        <div className="main-wrapper">
              ...
              <div className="hero-title-text-container">
                {!loading && (
                  <FadeContent
                    ...
                    delay={100}
                  >
                    <h1 className="text text-h-1 text-bold text-bricolage">
          ...
          <section id="why-us-section"  className="why-us-container">
            <div className="why-us-content">
              {!loading && (
                <SplitText
                  className="text text-h-1 text-bold text-bricolage"
                  delay={100}
                  duration={1.5}
                  ease="power3.out"
                  splitType="words"
              ...
              {!loading && (
                <SplitText
                  ...
                  textAlign="center"
                >
                  At Altiora, we lead the charge in manufacturing innovation.
                  Our tailored solutions enhance production capabilities,
                  delivering remarkable returns. <br/><br/>
          ...
          <section id="our-process-section"  className="our-process">
            ...
            <h6 className="our-process-link text text-h-6 text-onest text-regular">
              ...
              <Link to="#contact-section" className="text-medium">Get in touch</Link>
              &nbsp;for more details
            </h6> 
          </section>
            ...
            <div className="contact-form">
              <div className="contact-header">
                ...
                <h5 className="text text-h-6 text-light text-onest">
                  ...
                  just have a question, feel free to reach out. Our team is
                  ready to help.
                </h5>
              </div>
              <ContactForm />
